...
HD_PWD='C:/Users/Fabiano/Desktop/Trabalho_1_MicroII/Trabalho_1_MicroII.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Trabalho_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Trabalho_1.tcl -notrace
