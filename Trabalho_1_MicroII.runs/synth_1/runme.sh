...
HD_PWD='C:/Users/Fabiano/Desktop/Trabalho_1_MicroII/Trabalho_1_MicroII.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Trabalho_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Trabalho_1.tcl
